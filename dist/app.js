...
var _elm_lang$elm_architecture_tutorial$Display$output = _elm_lang$core$Native_Platform.outgoingPort(
	'output',
	function (v) {
		return v;
	});
...
var _elm_lang$elm_architecture_tutorial$Views_Static$header = A2(
	_elm_lang$html$Html$nav,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Chyno Test App'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('User Kata'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Kata'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
...
var _elm_lang$elm_architecture_tutorial$Views_Kata$katadetailsview = function (kata) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(kata.name),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(
											_elm_lang$elm_architecture_tutorial$Models$SetName(kata)),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(kata.code),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(
												_elm_lang$elm_architecture_tutorial$Models$SetCode(kata)),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(kata.test),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(
													_elm_lang$elm_architecture_tutorial$Models$SetTest(kata)),
												_1: {ctor: '[]'}
											}
										}
									},
										...
										_elm_lang$html$Html$textarea,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(
														_elm_lang$elm_architecture_tutorial$Models$SetDescription(kata)),
													_1: {ctor: '[]'}
												}
											}
										},
											...
											_1: {
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_elm_lang$elm_architecture_tutorial$Models$Save(kata)),
													_1: {ctor: '[]'}
												}
											}
										},
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Models$Cancel),
														_1: {ctor: '[]'}
													}
												}
											},
						...
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_elm_lang$elm_architecture_tutorial$Models$Edit(kata)),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
							...
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_elm_lang$elm_architecture_tutorial$Models$Delete(kata)),
										_1: {ctor: '[]'}
									}
								}
							},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(kata.name),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(kata.description),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _elm_lang$elm_architecture_tutorial$View$katasview = function (katas) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _elm_lang$elm_architecture_tutorial$View$kataview, katas)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Models$Add),
							_1: {ctor: '[]'}
						}
					},
					{
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('code goes her'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$Views_Static$header,
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Current Katas'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										_0: A2(
											...
											},
											{
												...
												_0: function () {
													var _p0 = model.kata;
													if (_p0.ctor === 'Nothing') {
														return _elm_lang$elm_architecture_tutorial$View$katasview(model.katas);
													} else {
														return _elm_lang$elm_architecture_tutorial$Views_Kata$katadetailsview(
															A2(_elm_lang$core$Maybe$withDefault, _elm_lang$elm_architecture_tutorial$Models$defaultkata, model.kata));
													}
												}(),
												_1: {ctor: '[]'}
											}),
...
var _elm_lang$elm_architecture_tutorial$Main$updateKata = F2(
	function (katas, updatedKata) {
		var pick = function (currentKata) {
			return _elm_lang$core$Native_Utils.eq(updatedKata.id, currentKata.id) ? updatedKata : currentKata;
		};
		var updateList = function (players) {
			return A2(_elm_lang$core$List$map, pick, players);
		};
		return updateList(katas);
	});
var _elm_lang$elm_architecture_tutorial$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_elm_lang$elm_architecture_tutorial$Models$defaultModel,
	{ctor: '[]'});
			...
			case 'Add':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							kata: _elm_lang$core$Maybe$Just(_elm_lang$elm_architecture_tutorial$Models$defaultkata)
						}),
					{ctor: '[]'});
			case 'Edit':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							kata: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					{ctor: '[]'});
			case 'Save':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							kata: _elm_lang$core$Maybe$Nothing,
							katas: A2(_elm_lang$elm_architecture_tutorial$Main$updateKata, model.katas, _p0._0)
						}),
					{ctor: '[]'});
			case 'Delete':
				var _p1 = _p0._0;
			...
			case 'SetTest':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							kata: _elm_lang$core$Maybe$Just(
								A5(_elm_lang$elm_architecture_tutorial$Models$Kata, _p2.id, _p2.name, _p2.code, _p0._1, _p2.description))
						}),
					{ctor: '[]'});
			case 'SetName':
				var _p3 = _p0._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							kata: _elm_lang$core$Maybe$Just(
								A5(_elm_lang$elm_architecture_tutorial$Models$Kata, _p3.id, _p0._1, _p3.code, _p3.test, _p3.description))
						}),
					{ctor: '[]'});
			case 'SetCode':
				var _p4 = _p0._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							kata: _elm_lang$core$Maybe$Just(
								A5(_elm_lang$elm_architecture_tutorial$Models$Kata, _p4.id, _p4.name, _p0._1, _p4.test, _p4.description))
						}),
					{ctor: '[]'});
			default:
				var _p5 = _p0._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							kata: _elm_lang$core$Maybe$Just(
								A5(_elm_lang$elm_architecture_tutorial$Models$Kata, _p5.id, _p5.name, _p5.code, _p5.test, _p0._1))
						}),
					{ctor: '[]'});
		}
	});
